...
<body>
  ...
  <section id="branding" class="branding service-page pb-5">
    <div class="container">
      <div class="row">
        <div class="col-md-6">
          <div class="hero-img">
        ...
        <div class="col-md-6">
          <div class="content">
            ...
            <ul class="offer">
              ...
              <li><i class="fa-regular fa-circle-right"></i>
                <p>Blog &amp; website content writing</p>
              </li>
              <li><i class="fa-regular fa-circle-right"></i>
          ...
          <div class="col-md-6">
            <div class="why-choose-box mb-5">
              ...
              <div class="why-choose-content">
                ...
                <p>Get found by people actively searching for what you offer.</p>
              </div>
            </div>
            ...
            <div class="why-choose-box mb-5">
              ...
              <div class="why-choose-content">
                ...
                <p>Position your brand as a thought leader in your industry.</p>
              </div>
            </div>
          </div>
          <div class="col-md-6">
            <div class="why-choose-box mb-5">
              ...
              <div class="why-choose-content">
                ...
                <p>Provide content that solves real problems and builds trust.</p>
              </div>
            </div>
            <div class="why-choose-box mb-5">
              <div class="why-choose-img">
              ...
              <div class="why-choose-content">
                ...
                <p>Rank higher on Google for high-value keywords.</p>
              </div>
            </div>
          </div>
        </div>
